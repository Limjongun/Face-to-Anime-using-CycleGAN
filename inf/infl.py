...
# Pakai LoRA final:
LORA_DIR = "out/lora-domainB"  # bisa juga: "out/lora-domainB/checkpoint-2000"
...
OUTPUT_DIR = Path("out_inpaint")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

PROMPT = "domain B style, keep same identity, keep same composition"
